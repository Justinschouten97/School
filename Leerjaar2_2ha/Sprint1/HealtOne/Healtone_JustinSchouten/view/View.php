...
class View
{
    ...
    public function showPatienten($result = null)
    {
        ...
        echo "<h2 class=\"text-center\">Patienten overzicht</h2> <form action='index.php' method='post'>
                               <input type='hidden' name='showFormP' value='0'>
            ...
            foreach ($patienten as $patient) {
                echo "<div class=\"patient\">
                      ...
                      <form action='index.php' method='post'>
                       <input type='hidden' name='showFormP' value='$patient->id'><input type='submit' value='wijzigen'/></form>
                        <form action='index.php' method='post'>
                       <input type='hidden' name='deleteP' value='$patient->id'><input type='submit' value='verwijderen'/></form>
                    </div>";
            }
        } else {
    ...
    public function showFormPatienten($id = null)
    {
        ...
        <table>
            ...
            <tr><td>
                <input type='submit' name='updateP' value='opslaan'></td><td>
            </td></tr></table>
            </form>
        </body>
        </html>";
        ...
        <table>
            ...
            <tr><td>
                <input type='submit' name='createP' value='opslaan'></td><td>
            </td></tr></table>
            </form>
        </body>
        </html>";
    ...
    public function showArtsen($result = null)
    {
        ...
        echo "<h2 class=\"text-center\">Artsen overzicht</h2> <form action='index.php' method='post'>
                               <input type='hidden' name='showFormA' value='0'>
                               <input class='btn btn-block' type='submit' value='toevoegen'/>
                               </form></div></body><br></html>";
        if ($artsen !== null) {
            echo "
            ...
            foreach ($artsen as $arts) {
                echo "<div class=\"arts\">
                      ...
                      <form action='index.php' method='post'>
                       <input type='hidden' name='showFormA' value='$arts->artsID'><input type='submit' value='wijzigen'/></form>
                        <form action='index.php' method='post'>
                       <input type='hidden' name='deleteA' value='$arts->artsID'><input type='submit' value='verwijderen'/></form>
                    </div>";
            }
        } else {
    ...
    public function showFormArtsen($artsID = null)
    {
        ...
        <table>
            ...
            <tr><td>
                <input type='submit' name='updateA' value='opslaan'></td><td>
            </td></tr></table>
            </form>
        </body>
        </html>";
        ...
        <table>
            ...
            <tr><td>
                <input type='submit' name='createA' value='opslaan'></td><td>
            </td></tr></table>
            </form>
        </body>
        </html>";
    ...
    public function showMedicijnen($result = null)
    {
        ...
        echo "<h2 class=\"text-center\">Medicijnen overzicht</h2> <form action='index.php' method='post'>
                               <input type='hidden' name='showFormM' value='0'>
                               <input class='btn btn-block' type='submit' value='toevoegen'/>
                               </form></div></body><br></html>";
        if ($medicijnen !== null) {
            echo "
            ...
            foreach ($medicijnen as $medicijn) {
                echo "<div class=\"medicijn\">
                      ...
                      <form action='index.php' method='post'>
                       <input type='hidden' name='showFormM' value='$medicijn->medicijnID'><input type='submit' value='wijzigen'/></form>
                        <form action='index.php' method='post'>
                       <input type='hidden' name='deleteM' value='$medicijn->medicijnID'><input type='submit' value='verwijderen'/></form>
                    </div>";
            }
        } else {
    ...
    public function showFormMedicijnen($medicijnID = null)
    {
        ...
        <table>
            ...
            <tr><td>
                <input type='submit' name='updateM' value='opslaan'></td><td>
            </td></tr></table>
            </form>
        </body>
        </html>";
        ...
        <table>
            ...
            <tr><td>
                <input type='submit' name='createM' value='opslaan'></td><td>
            </td></tr></table>
            </form>
        </body>
        </html>";
    ...
    public function showRecepten($result = null)
    {
        ...
        echo "<h2 class=\"text-center\">Recepten overzicht</h2> <form action='index.php' method='post'>
                               <input type='hidden' name='showFormR' value='0'>
                               <input class='btn btn-block' type='submit' value='toevoegen'/>
                               </form></div></body><br></html>";
        if ($recepten !== null) {
            echo "
            ...
            foreach ($recepten as $recept) {
                echo "<div class=\"recept\">
                      ...
                      <form action='index.php' method='post'>
                       <input type='hidden' name='showFormR' value='$recept->receptenID'><input type='submit' value='wijzigen'/></form>
                        <form action='index.php' method='post'>
                       <input type='hidden' name='deleteR' value='$recept->receptenID'><input type='submit' value='verwijderen'/></form>
                    </div>";
            }
        } else {
    ...
    public function showFormRecepten($receptID = null)
    {
        ...
        <table>
            ...
            <tr><td>
                ...
                <input type='submit' name='updateR' value='opslaan'></td><td>
            </td></tr></table>
            </form>
        </body>
        </html>";
        ...
        <table>
            ...
            <tr><td>
                <input type='submit' name='createR' value='opslaan'></td><td>
            </td></tr></table>
            </form>
        </body>
        </html>";
